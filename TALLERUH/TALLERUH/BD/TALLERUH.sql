...
CREATE TABLE TiposLista --Adicional 1
(
...
CREATE TABLE TiposListaEspecialidad --Adicional 2
(
...
EXEC AGREGAREquipoLISTA 'Voltaje'
EXEC AGREGAREspecialidadLISTA 'Calidad'
SELECT * FROM TiposListaEspecialidad 
DELETE TiposLista  WHERE TipoEquipo = ''
